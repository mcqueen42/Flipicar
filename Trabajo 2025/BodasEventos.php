...
.image-left-text-right p {
  width: 55%; /* Ajusta el ancho del texto */
...
<body>
    ...
    <h2>Alquiler de coches para bodas, eventos y rodajes</h2>
    </div>
    <div class="image-left-text-right"> 
    <img src="img/eventos.png" alt="Descripción de la imagen">
    <p>
    Si estás planeando tu boda, evento o rodaje y estás buscando algo especial, el alquiler de <strong>coches clásicos para 
    bodas y eventos </strong>es una opción perfecta para aportar elegancia y distinción a vuestra celebración nada mejor que
     llegar con el alquiler coches para bodas y eventos. Podrás disfrutar de un traslado desde vuestro domicilio disfrutando
      de un paseo hasta la iglesia y, una vez hayáis contraído matrimonio, realizaréis un emocionante e íntimo traslado hasta
       el lugar de la celebración. Tenemos una gama de coches impecables para alquilar y estamos seguros de que encontrarás algo
        bonito para tu evento.
        <br>
        <a href="contacto.php" class="contact-button">Contáctanos</a>
    </p>
</div>
<div class="title-container">
<h2>Alquiler para todo tipo de eventos inolvidables</h2>
</div>
<div class="text-left-image-right">
    <p>
    Las mejores marcas de coches de lujo están en <strong>Flipicar</strong> . Ofrecen alquiler de coches para bodas y eventos, 
    desde Mercedes Benz clásicos hasta espectaculares Bentley. Tu boda o evento será inolvidable al llegar en un coche de lujo.
     También puedes elegir entre vehículos de marcas como BMW y la velocidad de los Lamborghini.

Ofrecen opciones para todo tipo de eventos, incluyendo coches descapotables. Su equipo es profesional y puntual, asegurando que 
tu boda sea genial. Confía en ellos para tener una experiencia inolvidable en tu evento especial.
<br>
        <a href="contacto.php" class="contact-button">Contáctanos</a>
    </p>
    <img src="img/eventosNegros.png" alt="Descripción de la imagen">
</div>
